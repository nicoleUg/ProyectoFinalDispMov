...
class NuevoProductoAppAdmin extends StatefulWidget {
  ...
  @override
  State<NuevoProductoAppAdmin> createState() => _NuevoProductoAppAdminState();
}

class _NuevoProductoAppAdminState extends State<NuevoProductoAppAdmin> {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<AdminMenuBloc, AdminMenuState>(
        ...
        builder: (context, state) {
          ...
          // Retrieve categories from BLoC if available, to populate the dropdown
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                RSTextField(
                                  ...
                                  hintText: 'Ej. Hamburguesa Doble Queso',
                                  enabled: !isLoading,
                                  validator: (value) {
